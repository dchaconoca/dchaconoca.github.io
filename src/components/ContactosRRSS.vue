<template>
  <div id="contactos-rrss">
    ...
    <div id="item2">
      ...
      <i class="fab fa-linkedin" v-bind:class="[esClaro ? 'texto-claro' : 'texto-oscuro']"></i></a>
    </div>
    <div id="item3">
    ...
    <div id="item5">
      ...
      <i class="fas fa-envelope-square" v-bind:class="[esClaro ? 'texto-claro' : 'texto-oscuro']"></i></a>
    </div>
  </div>
</template>
